...
> This file contains stable coaching context about the user's training background, goals, and
> preferences. Edit it directly to keep it accurate. Do not store automatically changing metrics
> here (those come from Hevy data). Claude reads this before making routine-level recommendations.
